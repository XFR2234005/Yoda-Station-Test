...
WebUI.click(findTestObject('Yoda_Flow_Sheet/Create Flow Sheet/button_Create_FlwSht'))
...
WebUI.click(findTestObject('Yoda_Flow_Sheet/Create Flow Sheet/Input Flow name'))

int RN

RN = ((Math.random() * 36987) as int)

numberFlowSheet = RN

GlobalVariable.CreatedFlowSheet = (('RETAILDIAM_ANE_COR_Test_AUTO' + numberFlowSheet.toString()) + 'account2admin')

WebUI.setText(findTestObject('Yoda_Flow_Sheet/Create Flow Sheet/Input Flow name'), GlobalVariable.CreatedFlowSheet)

WebUI.verifyElementPresent(findTestObject('Yoda_Flow_Sheet/Create Flow Sheet/Labe Auto Generate'), 0)

WebUI.verifyElementPresent(findTestObject('Yoda_Flow_Sheet/Create Flow Sheet/Labe Business name Disabled'), 0)
