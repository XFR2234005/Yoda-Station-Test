...
WebUI.closeWindowTitle('Log in to YODA NP REALM')
...
WebUI.verifyElementPresent(findTestObject('Keycloak/Key-uid'), 0)
...
WebUI.getAttribute(findTestObject('Keycloak/Value-is-corporate'), 'value')

WebUI.verifyEqual(WebUI.getAttribute(findTestObject('Keycloak/Value-is-corporate'), 'value'), 'true', null)

WebUI.getAttribute(findTestObject('Keycloak/Value-uid'), 'value')

WebUI.verifyEqual(WebUI.getAttribute(findTestObject('Keycloak/Value-uid'), 'value'), 'XFR2206005', null)
