...
WebUI.setText(findTestObject('Sign On/Username_Sandbox', [('variable') : 'standard_user']), Login_Admin)

WebUI.setText(findTestObject('Sign On/Password_Sandbox'), Password_Admin)
